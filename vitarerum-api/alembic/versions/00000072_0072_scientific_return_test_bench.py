"""Add the institution-scoped scientific-return test bench.

Revision ID: 0072_sr_test_bench
Revises: 0071_restore_agentic_link_pk
"""
...
revision: str = "0072_sr_test_bench"
down_revision: str | None = "0071_restore_agentic_link_pk"
