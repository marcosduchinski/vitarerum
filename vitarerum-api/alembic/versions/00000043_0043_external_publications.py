...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_external_publications_resource_type",
        "external_publications",
        ["resource_type"],
    )
    op.create_index(
        "ix_external_publications_resource_id", "external_publications", ["resource_id"]
    )
    op.create_index(
        "ix_external_publications_status", "external_publications", ["status"]
    )
    op.create_index(
        "ix_external_publications_token_hash",
        "external_publications",
        ["token_hash"],
        unique=True,
    )
    op.create_index(
        "ix_external_publications_profile", "external_publications", ["profile"]
    )
    op.create_index(
        "ix_external_publications_expires_at", "external_publications", ["expires_at"]
    )
    op.create_index(
        "ix_external_publications_created_by", "external_publications", ["created_by"]
    )
    op.create_index(
        "ix_external_publications_created_at", "external_publications", ["created_at"]
    )
    op.create_index(
        "ix_external_publications_published_at",
        "external_publications",
        ["published_at"],
    )
    op.create_index(
        "ix_external_publications_revoked_by", "external_publications", ["revoked_by"]
    )
    op.create_index(
        "ix_external_publications_revoked_at", "external_publications", ["revoked_at"]
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_external_publication_accesses_outcome",
        table_name="external_publication_accesses",
    )
    op.drop_index(
        "ix_external_publication_accesses_integration_client_id",
        table_name="external_publication_accesses",
    ...
    op.drop_index(
        "ix_external_publications_revoked_at", table_name="external_publications"
    )
    op.drop_index(
        "ix_external_publications_revoked_by", table_name="external_publications"
    )
    op.drop_index(
        "ix_external_publications_published_at", table_name="external_publications"
    )
    op.drop_index(
        "ix_external_publications_created_at", table_name="external_publications"
    )
    op.drop_index(
        "ix_external_publications_created_by", table_name="external_publications"
    )
    op.drop_index(
        "ix_external_publications_expires_at", table_name="external_publications"
    )
    op.drop_index(
        "ix_external_publications_profile", table_name="external_publications"
    )
    op.drop_index(
        "ix_external_publications_token_hash", table_name="external_publications"
    )
    op.drop_index("ix_external_publications_status", table_name="external_publications")
    op.drop_index(
        "ix_external_publications_resource_id", table_name="external_publications"
    )
    op.drop_index(
        "ix_external_publications_resource_type", table_name="external_publications"
    )
    op.drop_table("external_publications")

    sa.Enum(name="external_publication_access_outcome").drop(
        op.get_bind(), checkfirst=True
    )
    sa.Enum(name="external_publication_profile").drop(op.get_bind(), checkfirst=True)
    sa.Enum(name="external_publication_access_mode").drop(
        op.get_bind(), checkfirst=True
    )
    sa.Enum(name="external_publication_status").drop(op.get_bind(), checkfirst=True)
    sa.Enum(name="external_publication_resource_type").drop(
        op.get_bind(), checkfirst=True
    )
