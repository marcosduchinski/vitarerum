...
usando Neon Postgres e Ollama Cloud como dependencias externas.
...
CORS_ORIGINS=["https://vitarerum.example.com"]
PUBLIC_ORIGIN=https://vitarerum.example.com
SMTP_HOST=<host-smtp>
SMTP_PORT=587
SMTP_USERNAME=<usuario-smtp>
SMTP_FROM_ADDRESS=<remetente>
SMTP_USE_TLS=true
...
Formato recomendado para Neon:

```text
postgresql+asyncpg://neondb_owner:<senha>@ep-lingering-term-aba1dezp.eu-west-2.aws.neon.tech/neondb?ssl=require
```
...
Sucesso esperado: os secrets existem. Nao copie os valores para arquivos
versionados.
...
Depois de migrar um banco Neon vazio, a aplicacao ainda precisa de dados
...
- o script roda uma vez com sucesso contra o Neon;
...
processo FastAPI subiu, mas nao testa Neon, Ollama Cloud nem GCS. Complemente
...
- fazer pelo menos uma leitura protegida que consulte o Neon;
...
- `DATABASE_URL` aponta para Neon com `postgresql+asyncpg://...?...ssl=require`;
...
- smoke tests reais validam Neon, GCS (quando uploads estiverem habilitados) e
